  ...
  <form id="form-container">
    ...
    <div class="form-column">
      ...
      <div class="form-button-container">
        ...
        <button type="button" onclick="eliminarProducto()" disabled>Eliminar</button>
      </div>
    </div>
  </form>
</div>
...
function buscarProducto() {
  ...
  // Si se encontró el producto, mostrar su información
  if (productoEncontrado !== null) {
    ...
    document.querySelector("#form-container button:nth-of-type(2)").disabled = false;
  } else {
    alert("Lo Sentimos :c, El Producto No Existe");
  }
}
...
function eliminarProducto() {
  ...
  // Si se encontró el producto, eliminar su información
  if (productoEncontrado !== null) {
    ...
    document.querySelector("#form-container button:nth-of-type(2)").disabled = true;
  } else {
    alert("Lo Sentimos :c, El Producto No Existe");
  }
}
